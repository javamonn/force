...
fragment CollectionApp_collection on MarketingCollection {
  ...
  ...CollectionFilterContainer_collection_pmEfa
  __id: id
}

fragment CollectionFilterContainer_collection_pmEfa on MarketingCollection {
  ...
  ...CollectionRefetch_collection_pmEfa
  __id: id
}

fragment CollectionRefetch_collection_pmEfa on MarketingCollection {
  slug
